...
Understand "talk to [something]" and "speak to [something]" as talking to.
Check talking to:
	if the noun is a person:
		say "They stare at you. Their gaze pierces your soul. A sense of dread begins to take over. What do they see? Can they read your mind? Do they know what you've done?? Have you even done anything wrong???" instead;
	otherwise:
...
Understand "person" and "woman" as Lapis.
Instead of talking to Lapis:
	say "LAPIS: Hello! My name is Lapis. I've been sent here to make sure you reach your destination! Continuing south is the fastest way to get to your destination." [TODO: write this dialogue!]
...
Instead of examining or attacking or feeding or talking to or petting the dawg when the dawg is undescribed:
	say "Alright, fess up. How did you know the dawg was there? Are you cheating? Is this not your first playthrough? Hmph. I'm watching you now... well, not that I wasn't before, but now I'm WATCHING watching you. Okay?[paragraph break]Oh, also, the dawg is now attacking you. That's what you get.";
	now the dawg is described;
	now the dawg is done.
